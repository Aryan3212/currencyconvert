  ...
  return (
    <Card className="w-full max-w-2xl mx-auto mt-4 p-6 bg-white shadow-lg rounded-lg">
      ...
      <CardContent className="prose dark:prose-invert text-gray-700">
        ...
        <h2 className="text-2xl font-semibold mt-4">4. How We Use Your Information</h2>
        <p>
        ...
        <p>
          If you have any questions about this Privacy Policy, please contact us through our <a href="/contact" className="text-blue-500 hover:underline">contact page</a>.
        </p>
